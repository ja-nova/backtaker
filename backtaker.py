                ...
                with st.form(key="decision_form"):
                    ...
                    if submit_button:
                        ...
                        if decision_choice == "1":
                            ...
                            # Formulář pro výběr typu vztahu
                            with st.form(key="relaChoiceA_form"):
                                ...
                                if submit_button:
                                    ...
                                    # Formulář pro další volbu
                                    with st.form(key="relaChoiceB_form"):
                        ...
                        # Pokračuj pro ostatní volby stejně jako výše...
                        # HEALTH
                            ...
                            # Formulář pro výběr zdraví
                            with st.form(key="healChoiceA_form"):
                        ...
                        # MONEY
                            ...
                            with st.form(key="moneyChoiceA_form"):
                        ...
                        # CAREER
                            ...
                            # Formulář pro volbu typu kariéry
                            with st.form(key="careerChoiceA_form"):
                                ...
                                if submit_button:
                                    ...
                                    if careerChoiceA == "1":
                                        ...
                                        # Formulář pro volbu příčin kariéry
                                        with st.form(key="careerChoiceB_form"):
                                    ...
                                    if careerChoiceA == "2":
                                        ...
                                        # Formulář pro volbu důvodu pro missed opportunity
                                        with st.form(key="careerChoiceC_form"):
                        ...
                        # EDUCATION
                            ...
                            # Formulář pro volbu vzdělání
                            with st.form(key="eduChoiceA_form"):
                                ...
                                if submit_button:
                                    if eduChoiceA == "1":
                                        ...
                                        # Formulář pro volbu důvodu vzdělání
                                        with st.form(key="eduChoiceB_form"):
                                            ...
                                            if submit_button:
                                                if eduChoiceB == "1" or eduChoiceB == "2" or eduChoiceB == "3":
                                                    ...
                                                    st.write("I've just brought your opportunities back on the table. can you already see your new chances?")
                                                    st.write("however, would you have known your true priorities without exploring your previous choice?")
                                                    st.stop()
                        
                                    elif eduChoiceA == "2":
                                        st.write("regretting something we studied is not uncommon. let’s see how I can help.")
                                        st.write("why do you regret your education choice? what have you studied?")
                                        st.write("1. something that doesn't interest me.")
                                        st.write("2. something that I cannot use in the future.")
                                        st.write("3. something that others wanted me to study.")
                                        st.write("4. I regret my education choice for a different reason.")
                        
                                        # Formulář pro volbu důvodu pro regret vzdělání
                                        with st.form(key="eduChoiceC_form"):
                        ...
                        # MORALITY AND VALUES
                            ...
                            # Formulář pro volbu morálky
                            with st.form(key="moralChoiceA_form"):
                                ...
                                if submit_button:
                                    if moralChoiceA == "1" or moralChoiceA == "2" or moralChoiceA == "3" or moralChoiceA == "4" or moralChoiceA == "6":
                                        st.write("no matter how bad a thing you did, it's great that you realized your mistakes and you want to make the situation better.")
                                        ...
                                        st.write("however, would you even recognize your boundaries if you wouldn't have had chances to learn it?")
                                        st.stop()
                        ...
                        # CRIMES
                            ...
                            if crimeChoiceAA == "1":
                                ...
                                if crimeChoiceAAA == "1":
                                    ...
                                    st.write("your actions are undone now! you can safely look into the eyes of the people you have been stealing from.")
                                    ...
                                    st.write("your actions are undone now! you can safely look into the eyes of the people whose property you have damaged.")
                                    st.write("do you really feel better inside yourself though, when you didn't undo your action yourself?")
                                    st.stop()
                        
                                elif crimeChoiceAAA == "3":
                                    describing = st.text_input("\nthank you for saying. how would you describe what you have done? ", key="39")
                                    st.write("your actions are undone now! you can safely look into the eyes of the people you have scammed.")
                                    st.write("do you really feel better inside yourself though, when you didn't undo your action yourself?")
                                    st.stop()
                                ...
                                if crimeChoiceAB == "1":
                                    ...
                                    st.write("okay well... no problem.")
                                    st.write("i've just undone your actions! you can safely look into the eyes of the people you have harmed or killed.")
                                    st.write("do you truly feel better inside yourself though?")
                                    st.stop()
                                    ...
                                    st.write("okay well... no problem.")
                                    st.write("i've just undone your actions! you can safely look into the eyes of the people you have sexually abused.")
                                    ...
                                    st.write("okay well... no problem.")
                                    st.write("i've just undone your actions! you can safely look into the eyes of the people you have harmed.")
                                    ...
                                    st.write("okay well... no problem.")
                                    st.write("i've just undone your actions! you can safely look into the eyes of the people and animals whose lives you turned into hell.")
                                    st.write("do you truly feel better and fair inside yourself though? does it help you now that you know what you're capable of?")
                                    st.stop()
                        ...
                        if decision_choice == "8":
                            ...
                            st.write("2. I have spent too much time on videogames and social media and now I can't do my work for tomorrow.")
                            st.write("3. I always said 'maybe later' to my dreams and now I feel like it’s too late.")
                            st.write("4. I have given my time to the wrong people or wrong work.")
                            st.write("5. I have lost the best years of my life with focusing on silly things.")
                            st.write("6. I don't have enough time already to be with people I love.")
                            ...
                            if timeLossChoice == "1":
                                ...
                                st.write("will you be more careful next time in more important situations though?")
                                st.stop()
                            ...
                            if timeLossChoice == "2":
                                ...
                                st.write("however, do you think it will be easy to keep healthy time-management habits when you didn't learn how to build them step by step?")
                                st.stop()
                            ...
                            if timeLossChoice == "6":
                                ...
                                st.write("do you think this will change your approach to time in the future?")
                                st.stop()
