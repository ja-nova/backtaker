        ...
        if choice == "1":
            ...
            # CAREER
                ...
                if careerChoiceA == "2":
                    ...
                    st.write("I've just fixed your career path to feel better. can you already see your new opportunities?")
                    st.stop()
            ...
            # MORALITY AND VALUES
                ...
                if moralChoiceA == "1" or moralChoiceA == "2" or moralChoiceA == "3" or moralChoiceA == "4" or moralChoiceA == "6":
                    ...
                    st.write("however, would you even recognize your boundaries if you wouldn't have had the chance to learn them?")
                    st.stop()
            ...
            if decision_choice == "8":
                ...
                if timeLossChoice == "1":
                    ...
                    st.write("will you be more careful next time in a more important situation though?")
                    st.stop()
